 ...
 * This file defines FUSE lowlevel interface.
 * 
...
struct fuse_lowlevel_ops {
	 ...
	 */
	void function (fuse_req_t, fuse_ino_t, const(char)*) lookup;
	 ...
	 */
	void function (fuse_req_t, fuse_ino_t, c_ulong) forget;
	 ...
	 */
	void function (fuse_req_t, fuse_ino_t, fuse_file_info*) getattr;
	 ...
	 */
	void function (fuse_req_t, fuse_ino_t, stat_t*, int, fuse_file_info*) setattr;
	 ...
	 * @param ino the inode number
	 */
	void function (fuse_req_t, fuse_ino_t) readlink;
	 ...
	 */
	void function (fuse_req_t, fuse_ino_t, const(char)*, mode_t, dev_t) mknod;
	 ...
	 */
	void function (fuse_req_t, fuse_ino_t, const(char)*, mode_t) mkdir;
	 ...
	 */
	void function (fuse_req_t, fuse_ino_t, const(char)*) unlink;
	 ...
	 * @param name to remove
	 */
	void function (fuse_req_t, fuse_ino_t, const(char)*) rmdir;
	 ...
	 * @param name to create
	 */
	void function (fuse_req_t, const(char)*, fuse_ino_t, const(char)*) symlink;
	 ...
	 */
	void function (fuse_req_t, fuse_ino_t, const(char)*, fuse_ino_t, const(char)*) rename;
	 ...
	 */
	void function (fuse_req_t, fuse_ino_t, fuse_ino_t, const(char)*) link;
	 ...
	 */
	void function (fuse_req_t, fuse_ino_t, fuse_file_info*) open;
	 ...
	 * @param fi file information
	 */
	void function (fuse_req_t, fuse_ino_t, size_t, off_t, fuse_file_info*) read;
	 ...
	 * @param fi file information
	 */
	void function (fuse_req_t, fuse_ino_t, const(char)*, size_t, off_t, fuse_file_info*) write;
	 ...
	 * @param fi file information
	 */
	void function (fuse_req_t, fuse_ino_t, fuse_file_info*) flush;
	 ...
	 * @param fi file information
	 */
	void function (fuse_req_t, fuse_ino_t, fuse_file_info*) release;
	 ...
	 * @param fi file information
	 */
	void function (fuse_req_t, fuse_ino_t, int, fuse_file_info*) fsync;
	 ...
	 * @param fi file information
	 */
	void function (fuse_req_t, fuse_ino_t, fuse_file_info*) opendir;
	 ...
	 * @param fi file information
	 */
	void function (fuse_req_t, fuse_ino_t, size_t, off_t, fuse_file_info*) readdir;
	 ...
	 * @param fi file information
	 */
	void function (fuse_req_t, fuse_ino_t, fuse_file_info*) releasedir;
	 ...
	 * @param fi file information
	 */
	void function (fuse_req_t, fuse_ino_t, int, fuse_file_info*) fsyncdir;
	 ...
	 */
	void function (fuse_req_t, fuse_ino_t) statfs;
	 ...
	 *   fuse_reply_err
	 */
	void function (fuse_req_t, fuse_ino_t, const(char)*, const(char)*, size_t, int) setxattr;
	 ...
	 */
	void function (fuse_req_t, fuse_ino_t, const(char)*, size_t) getxattr;
	 ...
	 */
	void function (fuse_req_t, fuse_ino_t, size_t) listxattr;
	 ...
	 * @param name of the extended attribute
	 */
	void function (fuse_req_t, fuse_ino_t, const(char)*) removexattr;
	 ...
	 */
	void function (fuse_req_t, fuse_ino_t, int) access;
	 ...
	 * @param fi file information
	 */
	void function (fuse_req_t, fuse_ino_t, const(char)*, mode_t, fuse_file_info*) create;
	 ...
	 */
	void function (fuse_req_t, fuse_ino_t, fuse_file_info*, flock_t*) getlk;
	 ...
	 */
	void function (fuse_req_t, fuse_ino_t, fuse_file_info*, flock_t*, int) setlk;
	 ...
	 */
	void function (fuse_req_t, fuse_ino_t, size_t, ulong) bmap;
	 ...
	 */
	void function (fuse_req_t, fuse_ino_t, int, void*, fuse_file_info*, uint, const(void)*, size_t, size_t) ioctl;
	 ...
	 */
	void function (fuse_req_t, fuse_ino_t, fuse_file_info*, fuse_pollhandle*) poll;
	 ...
	 * @param fi file information
	 */
	void function (fuse_req_t, fuse_ino_t, fuse_bufvec*, off_t, fuse_file_info*) write_buf;
	 ...
	 */
	void function (fuse_req_t, void*, fuse_ino_t, off_t, fuse_bufvec*) retrieve_reply;
	 ...
	 * @param req request handle
	 */
	void function (fuse_req_t, size_t, fuse_forget_data*) forget_multi;
	 ...
	 */
	void function (fuse_req_t, fuse_ino_t, fuse_file_info*, int) flock;
	 ...
	 *             see fallocate(2)
	 */
	void function (fuse_req_t, fuse_ino_t, int, off_t, off_t, fuse_file_info*) fallocate;
}
 ...
 */
size_t fuse_add_direntry (fuse_req_t req, char* buf, size_t bufsize, const(char)* name, const(stat_t)* stbuf, off_t off);
 ...
 */
int fuse_lowlevel_notify_inval_inode (fuse_chan* ch, fuse_ino_t ino, off_t off, off_t len);
 ...
 * @return zero for success, -errno for failure
 */
int fuse_lowlevel_notify_inval_entry (fuse_chan* ch, fuse_ino_t parent, const(char)* name, size_t namelen);
 ...
 * @return zero for success, -errno for failure
 */
int fuse_lowlevel_notify_delete (fuse_chan* ch, fuse_ino_t parent, fuse_ino_t child, const(char)* name, size_t namelen);
 ...
 * @return zero for success, -errno for failure
 */
int fuse_lowlevel_notify_store (fuse_chan* ch, fuse_ino_t ino, off_t offset, fuse_bufvec* bufv, fuse_buf_copy_flags flags);
 ...
 * @return zero for success, -errno for failure
 */
int fuse_lowlevel_notify_retrieve (fuse_chan* ch, fuse_ino_t ino, size_t size, off_t offset, void* cookie);
 ...
 */
alias void function (fuse_req*, void*) fuse_interrupt_func_t;
 ...
 */
fuse_session* fuse_lowlevel_new (fuse_args* args, const(fuse_lowlevel_ops)* op, size_t op_size, void* userdata);
...
struct fuse_session_ops {
	 ...
	 */
	void function (void*, const(char)*, size_t, fuse_chan*) process;
 ...
 * @param ch channel on which the request was received
 */
void fuse_session_process (fuse_session* se, const(char)* buf, size_t len, fuse_chan* ch);
 ...
 * @param ch channel on which the request was received
 */
void fuse_session_process_buf (fuse_session* se, const(fuse_buf)* buf, fuse_chan* ch);
 ...
 */
int fuse_session_receive_buf (fuse_session* se, fuse_buf* buf, fuse_chan** chp);
 ...
 */
void* fuse_session_data (fuse_session* se);
...
struct fuse_chan_ops {
	 ...
	 */
	int function (fuse_chan**, char*, size_t) receive;
	 ...
	 */
	int function (fuse_chan*, const(iovec)*, size_t) send;
	 ...
	 * @param ch the channel
	 */
	void function (fuse_chan*) destroy;
}
 ...
 * @return zero on success, -errno on failure
 */
int fuse_chan_send (fuse_chan* ch, const(iovec)* iov, size_t count);
